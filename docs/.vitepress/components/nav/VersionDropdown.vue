...
const isChangelog = computed(() => page.value.relativePath === 'docs/changelog.md')

const items = computed(() => [
  {
    icon: 'List',
    text: 'Changelog',
    href: withBase('/docs/changelog'),
    external: false,
    active: isChangelog.value
  },
  { icon: 'Tag', text: 'Releases', href: `${REPO}/releases`, external: true },
  { icon: 'Bug', text: 'Report a bug', href: `${REPO}/issues/new/choose`, external: true }
])
