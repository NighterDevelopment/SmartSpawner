...
| Regions and claims | WorldGuard, GriefPrevention, Lands, Towny, SimpleClaimSystem, RedProtect, Residence | Checks access before opening, stacking, or breaking where supported |
